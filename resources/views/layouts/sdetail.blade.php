                            ...
                            <table class="table table-bordered">
                                ...
                                {{--@foreach ($collabs as $collab)--}}
                                    {{--<tr>--}}
                                        ...
                                        {{--<td><img src="upload/{{$collab->image}}" style="width:50px; height: "></td>--}}
                        ...
                        <div class="header">
                            ...
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li><a href="{{ url('scholarship') }}">Create</a></li>
                                        <li><a href="javascript:void(0);">Another action</a></li>
                                        <li><a href="javascript:void(0);">Something else here</a></li>
                                    </ul>
                                </li>
                            ...
                            <table class="table table-bordered">
                                ...
                                {{--@foreach ($scholarships as $scholarship)--}}
                                    {{--<tr>--}}
                                        ...
                                        {{--<td><img src="upload/{{$scholarship->image}}" style="width:50px; height: "></td>--}}
                                        ...
                                        {{--<td>--}}
                                            ...
                                            {{--</form>--}}
                                            {{--<a href="{{ route('collab.edit', $scholarship->id)}}">Edit</a>--}}
                                        {{--</td>--}}
                                    {{--</tr>--}}
                                {{--@endforeach--}}
                                {{--</tbody>--}}
